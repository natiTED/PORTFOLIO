...
export const gridItems = [
...

  {
    id: 5,
    title:
      "Currently doing projects by building dynamic websites on AWS Resources",
...
export const projects = [
  ...
  },
  {
    id: 2,
    title: "MOVIES APP",
    des: "A movie app with different functionalities like searching by category, date, and professional admin dashboard.",
    img: "/movies-app.png",
    iconLists: [
      "/re.svg",
      "/tail.svg",
...
export const workExperience = [
  ...
  },
  {
    ...
    desc: "Designed and developed sample website app for the company I was accepted as an intern in and showcase to the CEO.",
